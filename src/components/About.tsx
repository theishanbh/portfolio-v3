...
function About() {
  return (
    <div className="h-auto pl-12 pb-10 mb-10">
      <h1 className=" text-5xl font-extrabold pb-2 underline">
        A little about me
      </h1>
      ...
      <div className="flex ml-8 overflow-hidden ">
        ...
        <div className="flex-1 flex flex-col gap-2 text-2xl justify-center">
          <h2 className="text-5xl pt-6 pb-5 font-bold"> My Skills</h2>
          <h3 className="text-2xl pt-1 pb-1"> Web Dev </h3>
